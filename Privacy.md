# Isabot Privacy Policy

Isabot processes Discord messages in designated channels in order to participate in conversations and provide AI-generated responses.

Relevant message content and recent conversation context may be sent to a third-party AI service solely to generate the bot's responses. We do not use Discord messages to train AI models or for advertising.
...
By interacting in channels where Isabot is active, or by sending it direct messages, users acknowledge that their messages may be processed as described above.
